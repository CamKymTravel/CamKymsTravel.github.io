const CACHE='tcc-continuity-4.5.728-shell-simulation-compact-batch1294-20260830';
...
const APP_SHELL=[
  ...
  './styles.css?v=4.5.728-shell-simulation-compact-batch1294-20260830',
  './app.js?v=4.5.728-shell-simulation-compact-batch1294-20260830',
  './manifest.webmanifest?v=4.5.728-shell-simulation-compact-batch1294-20260830',
  './icon.svg?v=4.5.728-shell-simulation-compact-batch1294-20260830',
  './apple-touch-icon.png?v=4.5.728-shell-simulation-compact-batch1294-20260830',
  './compass-mark.svg?v=4.5.728-shell-simulation-compact-batch1294-20260830',
  './launch-ipad-102-2160x1620.png?v=4.5.728-shell-simulation-compact-batch1294-20260830',
  './launch-ipad-air-2360x1640.png?v=4.5.728-shell-simulation-compact-batch1294-20260830',
  './launch-ipad-classic-2048x1536.png?v=4.5.728-shell-simulation-compact-batch1294-20260830',
  './launch-ipad-mini6-2266x1488.png?v=4.5.728-shell-simulation-compact-batch1294-20260830',
  './launch-ipad-pro105-2224x1668.png?v=4.5.728-shell-simulation-compact-batch1294-20260830',
  './launch-ipad-pro11-2388x1668.png?v=4.5.728-shell-simulation-compact-batch1294-20260830',
  './launch-ipad-pro11-m4-2420x1668.png?v=4.5.728-shell-simulation-compact-batch1294-20260830',
  './launch-ipad-pro129-2732x2048.png?v=4.5.728-shell-simulation-compact-batch1294-20260830',
  './launch-ipad-pro13-m4-2752x2064.png?v=4.5.728-shell-simulation-compact-batch1294-20260830',
  './banner-pack.js',
  './banner-pack.js?v=4.5.728-shell-simulation-compact-batch1294-20260830',
];
function scopeInfo(){
