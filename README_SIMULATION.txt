TRAVEL COMMAND CENTRE — BATCH 1221 SCREENSHOT SIMULATION

Purpose: physical-iPad screenshot review of the polished screens.
Simulation date: 10/07/2029
Current stay: Istanbul, Turkey

This build uses a simulation-only local-storage key and will not intentionally use the normal Travel Command Centre data key.
